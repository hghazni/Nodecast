...
export function validateApiKey(apiKey: any) {
...
export function validateCityId(cityId: any) {
...
export function validateUnits(units: any) {
...
export async function queryCurrentWeather(cityId: any, units: any, apiKey: any) {
...
export async function queryWeatherForecast(cityId: any, units: any, apiKey: any) {
...
function getApiUrl(baseUri: any, cityId: any, units: any, apiKey: any) {
